...
public float inputVertical;
    ...
    Animator animator;
    string currentState;
    const string PLAYER_IDLE = "Player-down";
    const string PLAYER_WALK_LEFT = "Player-down";
    const string PLAYER_WALK_RIGHT= "Player-down";
    const string PLAYER_WALK_UP = "Player-down";
