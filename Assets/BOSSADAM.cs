...
public class BOSSADAM : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        healthBar = GameObject.FindGameObjectWithTag("HealthBarBossAdam").GetComponent<HealthBar>();

     
            maxHealth = Damagesystem.AdamMaxHealth;
