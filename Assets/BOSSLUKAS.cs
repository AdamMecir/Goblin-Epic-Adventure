...
using UnityEngine;
public class BOSSLUKAS : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        healthBar = GameObject.FindGameObjectWithTag("HealthBarBossLukas").GetComponent<HealthBar>();


        maxHealth = Damagesystem.LukasMaxHealth;
